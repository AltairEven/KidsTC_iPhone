...
@interface LoveHouseListViewController () <LoveHouseListViewDelegate, BMKMapViewDelegate, KTCAnnotationTipWelfareItemViewDelegate>
...
- (BMKAnnotationView *)mapView:(BMKMapView *)mapView viewForAnnotation:(id <BMKAnnotation>)annotation {
    ...
    if ([itemModels count] > index) {
        LoveHouseListItemModel *item = [itemModels objectAtIndex:index];
        KTCAnnotationTipWelfareItemView *tipView = [[KTCAnnotationTipWelfareItemView alloc] initWithFrame:CGRectMake(0, 0, 200, 120)];
        [tipView setItemModel:[KTCAnnotationTipWelfareItem welfareItemFromLoveHouseListItemModel:item]];
...
- (void)resetAnnotations {
    ...
    for (NSUInteger index = 0; index < [itemModels count]; index ++) {
        LoveHouseListItemModel *model = [itemModels objectAtIndex:index];
