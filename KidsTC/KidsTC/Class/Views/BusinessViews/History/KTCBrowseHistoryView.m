...
- (void)buildSubviews {
    ...
    [self.activityIndicator setColor:[AUITheme theme].globalThemeColor];
    
    [self.serviceButton setBackgroundColor:[[AUITheme theme].globalThemeColor colorWithAlphaComponent:0.7] forState:UIControlStateNormal];
    ...
    [self.storeButton setBackgroundColor:[[AUITheme theme].globalThemeColor colorWithAlphaComponent:0.7] forState:UIControlStateNormal];
