...
- (void)awakeFromNib {
    ...
    [self.headerBGView setBackgroundColor:[[KTCThemeManager manager] defaultTheme].globalBGColor];
...
- (void)drawTriangleForHeader {
    ...
    maskBorderLayer.fillColor = [[KTCThemeManager manager] defaultTheme].globalCellBGColor.CGColor;
