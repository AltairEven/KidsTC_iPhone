...
- (void)buildSubviews {
    ...
    [self.refundAmountView setContentColor:[[KTCThemeManager manager] defaultTheme].globalThemeColor];
    ...
    [self.backPointNumberLabel setTextColor:[[KTCThemeManager manager] defaultTheme].globalThemeColor];
